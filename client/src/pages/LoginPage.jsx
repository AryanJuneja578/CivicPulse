    ...
    <div className="auth-page-container">
      <div className="auth-card">
        ...
        <div style={{
          ...
          <span>
            Demo Account: <strong>{activeTab === 'citizen' ? 'aryan@civicpulse.gov.in' : 'officer@civicpulse.gov.in'}</strong>
          </span>
          <button
            type="button"
            ...
            onClick={() => {
              if (activeTab === 'citizen') {
                setEmail('aryan@civicpulse.gov.in');
                setPassword('demo1234');
              } else {
                setEmail('officer@civicpulse.gov.in');
                setPassword('demo1234');
              }
            }}
          >
